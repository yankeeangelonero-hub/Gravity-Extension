        ...
        overlay.innerHTML = `
            <div class="gl-setup-popup">
                <div class="gl-setup-header">
                    ...
                    <p style="color:#999;font-size:12px;margin:4px 0 0">Set the opening arc and optional combat context. Leave anything blank for the LLM to derive from the character card and scenario.</p>
                </div>
...
1. WORLD SETUP:
${answers.combat_rules ? '> MAP_SET world field=constants key=combat_rules value="[combat rules summary]" -- Combat scale and world capabilities\n' : ''}> SET world field=world_state value="[macro reality]" -- World state
